...
class AgentellIJActionPromoter : ActionPromoter {
    ...
    private val editorPriority: Map<Class<out AnAction>, Int> = mapOf(
        AddLinesToContextAction::class.java to 0,
        AddFileToContextAction::class.java to 1,
        AddDirectoryToContextAction::class.java to 2,
    )

    private val nonEditorPriority: Map<Class<out AnAction>, Int> = mapOf(
        AddDirectoryToContextAction::class.java to 0,
        AddFileToContextAction::class.java to 1,
        AddLinesToContextAction::class.java to 2,
    )

    override fun promote(actions: List<AnAction>, context: DataContext): List<AnAction> {
        val priority = if (context.getData(CommonDataKeys.EDITOR) != null) editorPriority else nonEditorPriority

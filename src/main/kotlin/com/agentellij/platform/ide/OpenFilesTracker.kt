...
import com.agentellij.core.util.DebouncedTask
...
class OpenFilesTracker(
    ...
    private fun toRelativePath(vf: VirtualFile?): String? {
        return VirtualFilePaths.relativePath(vf, project.basePath)
    }

    override fun dispose() {
        debouncedPush.cancel()
        runQuietly(diagnostics, "cancel the open file poll") { scheduled?.cancel(false) }
        scheduled = null
    }
